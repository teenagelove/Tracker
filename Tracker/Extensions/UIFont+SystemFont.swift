...
extension UIFont {
    static let little = UIFont.systemFont(ofSize: 12, weight: .medium)
    ...
    static let header = UIFont.systemFont(ofSize: 19, weight: .bold)
    static let onboarding = UIFont.systemFont(ofSize: 32, weight: .bold)
}
